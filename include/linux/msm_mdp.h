...
#define MSMFB_SKY_LCD_SMART_DIMMING_READ   _IOW(MSMFB_IOCTL_MAGIC, 159, char)
#define MSMFB_SKY_LCD_SMART_DIMMING_READ_GAMMA_300NIT   _IOW(MSMFB_IOCTL_MAGIC, 160, char)
#define MSMFB_SKY_LCD_SMART_DIMMING_WRITE  _IOW(MSMFB_IOCTL_MAGIC, 161, char)
#endif
